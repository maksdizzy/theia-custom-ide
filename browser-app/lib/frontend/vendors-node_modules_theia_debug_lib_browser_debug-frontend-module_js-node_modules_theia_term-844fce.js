"use strict";
(self["webpackChunkbrowser_app"] = self["webpackChunkbrowser_app"] || []).push([["vendors-node_modules_theia_debug_lib_browser_debug-frontend-module_js-node_modules_theia_term-844fce"],{
...
exports.DebugPrefixConfiguration = DebugPrefixConfiguration = DebugPrefixConfiguration_1 = tslib_1.__decorate([
...
exports.DisassemblyViewContribution = DisassemblyViewContribution = tslib_1.__decorate([
    (0, inversify_1.injectable)(),
    tslib_1.__metadata("design:paramtypes", [])
...
let InstructionRenderer = InstructionRenderer_1 = class InstructionRenderer extends lifecycle_1.Disposable {
    ...
    openSourceCode(instruction) {
        ...
        if (instruction) {
            ...
            const selection = instruction.endLine ? {
                ...
                end: { line: instruction.endLine, character: (_b = instruction.endColumn) !== null && _b !== void 0 ? _b : 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */ }
            } : {
                start: { line: instruction.line, character: (_c = instruction.column) !== null && _c !== void 0 ? _c : 0 },
                end: { line: instruction.line, character: (_d = instruction.endColumn) !== null && _d !== void 0 ? _d : 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */ }
            };
            const openerOptions = {
                selection,
                mode: 'activate',
            ...
            (0, browser_1.open)(this.openerService, new uri_1.URI(sourceURI.toString()), openerOptions);
        }
    }
...
exports.InstructionRenderer = InstructionRenderer = InstructionRenderer_1 = tslib_1.__decorate([
...
let DisassemblyViewWidget = DisassemblyViewWidget_1 = class DisassemblyViewWidget extends browser_1.BaseWidget {
    ...
    init() {
        ...
        this._fontInfo = fontInfo_1.BareFontInfo.createFromRawSettings(this.toFontInfo(), pixelRatio_1.PixelRatio.getInstance(window).value);
        this.editorPreferences.onPreferenceChanged(() => this._fontInfo = fontInfo_1.BareFontInfo.createFromRawSettings(this.toFontInfo(), pixelRatio_1.PixelRatio.getInstance(window).value));
    ...
    createPane() {
        ...
        const monacoInstantiationService = standaloneServices_1.StandaloneServices.get(instantiation_1.IInstantiationService);
...
exports.DisassemblyViewWidget = DisassemblyViewWidget = DisassemblyViewWidget_1 = tslib_1.__decorate([
    (0, inversify_1.injectable)()
...
//# sourceMappingURL=vendors-node_modules_theia_debug_lib_browser_debug-frontend-module_js-node_modules_theia_term-844fce.js.map