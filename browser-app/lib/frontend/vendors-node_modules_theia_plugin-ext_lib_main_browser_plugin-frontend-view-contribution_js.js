(self["webpackChunkbrowser_app"] = self["webpackChunkbrowser_app"] || []).push([["vendors-node_modules_theia_plugin-ext_lib_main_browser_plugin-frontend-view-contribution_js"],{
...
let PluginWorker = class PluginWorker {
    constructor() {
        this.worker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("_6154-_3ce7-_2e93-_b43e"), __webpack_require__.b));
        const channel = new channel_1.BasicChannel(() => {
            const writer = new uint8_array_message_buffer_1.Uint8ArrayWriteBuffer();
            writer.onCommit(buffer => {
    ...
    async syncPlugins() {
        ...
        try {
            ...
            for (const contribution of this.contributions.values()) {
                if (contribution.plugin.metadata.outOfSync && !ignoredPlugins.includes(plugin_protocol_1.PluginIdentifiers.componentsToVersionedId(contribution.plugin.metadata.model))) {
...
let EditorModelService = class EditorModelService {
    ...
    modelCreated(model) {
        ...
        model.onModelWillSaveModel(async (e) => {
            await core_1.Listener.await(e, this.onModelWillSaveListeners);
        });
...
//# sourceMappingURL=vendors-node_modules_theia_plugin-ext_lib_main_browser_plugin-frontend-view-contribution_js.js.map