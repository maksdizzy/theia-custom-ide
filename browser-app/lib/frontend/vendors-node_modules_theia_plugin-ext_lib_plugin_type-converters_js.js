"use strict";
(self["webpackChunkbrowser_app"] = self["webpackChunkbrowser_app"] || []).push([["vendors-node_modules_theia_plugin-ext_lib_plugin_type-converters_js"],{
...
(function (PluginIconPath) {
    ...
    function is(item) {
        return typeof item === 'string' || item instanceof types_impl_1.URI || typeof item === 'object' && !!item && 'light' in item && 'dark' in item;
    }
    PluginIconPath.is = is;
...
})(PluginIconPath || (exports.PluginIconPath = PluginIconPath = {}));
...
//# sourceMappingURL=vendors-node_modules_theia_plugin-ext_lib_plugin_type-converters_js.js.map