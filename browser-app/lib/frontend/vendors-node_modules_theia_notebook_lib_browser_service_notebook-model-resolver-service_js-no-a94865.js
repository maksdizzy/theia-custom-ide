...
let NotebookCellActionContribution = NotebookCellActionContribution_1 = class NotebookCellActionContribution {
    ...
    registerMenus(menus) {
        ...
        menus.registerSubmenu(NotebookCellActionContribution_1.CONTRIBUTED_CELL_ACTION_MENU, '');
        ...
        menus.linkCompoundMenuNode({
            newParentPath: NotebookCellActionContribution_1.ADDITIONAL_ACTION_MENU,
            submenuPath: NotebookCellActionContribution_1.CONTRIBUTED_CELL_ACTION_MENU
        });
        ...
        menus.registerSubmenu(NotebookCellActionContribution_1.CONTRIBUTED_CELL_EXECUTION_MENU, core_1.nls.localizeByDefault('More...'), { icon: (0, browser_1.codicon)('chevron-down') });
        ...
        menus.registerSubmenu(NotebookCellActionContribution_1.ADDITIONAL_OUTPUT_SIDEBAR_MENU, core_1.nls.localizeByDefault('More'), { icon: (0, browser_1.codicon)('ellipsis') });
...
class NotebookCellListView extends React.Component {
    ...
    render() {
        return React.createElement("ul", { className: 'theia-notebook-cell-list', ref: this.cellListRef, onDragStart: e => this.onDragStart(e) },
            this.props.notebookModel.getVisibleCells()
                ...
                React.createElement(NotebookCellDivider, { menuRegistry: this.props.menuRegistry, isVisible: () => this.isEnabled(), onAddNewCell: handler => this.onAddNewCell(handler, index), onDrop: e => this.onDrop(e, index), onDragOver: e => this.onDragOver(e, cell, 'top') }),
            ...
            React.createElement(NotebookCellDivider, { menuRegistry: this.props.menuRegistry, isVisible: () => this.isEnabled(), onAddNewCell: handler => this.onAddNewCell(handler, this.props.notebookModel.cells.length), onDrop: e => this.onDrop(e, this.props.notebookModel.cells.length - 1), onDragOver: e => this.onDragOver(e, this.props.notebookModel.cells[this.props.notebookModel.cells.length - 1], 'bottom') }));
    }
    ...
    onAddNewCell(handler, index) {
        if (this.isEnabled()) {
            ...
            handler(this.props.notebookModel, index);
        }
    }
...
function NotebookCellDivider({ isVisible, onAddNewCell, onDrop, onDragOver, menuRegistry }) {
    ...
    const menuPath = notebook_actions_contribution_1.NotebookMenus.NOTEBOOK_MAIN_TOOLBAR_CELL_ADD_GROUP; // we contribute into this menu, so it will exist
    const menuItems = menuRegistry.getMenu(menuPath).children.filter(item => core_1.CommandMenu.is(item)).map(item => item);
    const renderItem = (item) => {
        ...
        return React.createElement("button", { key: item.id, className: 'theia-notebook-add-cell-button', onClick: () => onAddNewCell(execute), title: core_1.nls.localizeByDefault(`Add ${item.label} Cell`) },
